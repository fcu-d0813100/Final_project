        ...
        <>
            ...
            <main className="container">
                ...
                <section className={styles.section}>
                    <h1 className={`text-center ${styles.h1}`}>【NARS】九月購物狂歡，購買指定商品享85折</h1>
                    <article className={styles.article}>
                        <div className={`align-self-stretch ${styles.h6}`}>
                            <span className={styles.h5}>活動日期</span><br />
                            2024/9/01 00:00 - 2024/9/30 23:59 (GMT+08)
                        </div>
                        <hr className="align-self-stretch" />
                        <div className={`align-self-stretch ${styles.h6}`}>
                            <span className={styles.h5}>優惠內容</span><br />
                            活動期間內購買NARS指定商品，滿2000即享有85折優惠。
                        </div>
                        <hr className="align-self-stretch" />
                        <div className={`align-self-stretch ${styles.h6}`}>
                            <span className={styles.h5}>活動詳情</span><br />
